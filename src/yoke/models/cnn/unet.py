"""Custom UNet implementations.

U-Net from https://github.com/milesial/Pytorch-UNet with slight modifications.
"""
...
class DoubleConv(nn.Module):
    ...
    def __init__(
        self, in_channels: int, out_channels: int, mid_channels: int = None
    ) -> None:
...
class Down(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass through downscaling block."""
        return self.maxpool_conv(x)


class Up(nn.Module):
    """Upscaling with Upsample or ConvTranspose2d then double conv."""
...
class UNet(nn.Module):
    """UNet modified from https://github.com/milesial/Pytorch-UNet."""
